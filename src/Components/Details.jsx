...
function Details() {
  return (
    <section className="details-section section-gap" data-reveal>
      <div className="details-image reveal-left" data-reveal>
        <img src={image} alt="About our brand" />
      </div>

      <div className="details-content reveal-right" data-reveal>
        <span className="eyebrow">About Our Brand</span>
        <h2>Style, quality, and comfort in every step.</h2>
